...
uci set system.@system[0].hostname='S912'                             # 修改主机名称为Phicomm-N1
...
sed -i "s/OpenWrt /RexYu Compiled in $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ          # 增加个性名字${Author}默认为你的github账号
